package org.example.springposnew.config;
...
@Configuration
@ComponentScan(basePackages = "org.example.springposnew")
@EnableJpaRepositories(basePackages = "org.example.springposnew.dao")
